...
<form id="ff" method="post" enctype="multipart/form-data">
    ...
    <table id="addMes">
        ...
        <tr>
            ...
            <td colspan="3"><input class="easyui-combobox" name="newid" id="newid" style="width: 100%;"/></td>
        </tr>
        <tr>
...
<script type="text/javascript">
    var url = '<%=basePath %>org_news/newsOlAdd';
    var action = "add";
    <c:choose>
    <c:when test="${id != '' && id != null}">
    url = '<%=basePath %>org_news/newsOlAddEdit';
    action = "edit";
    </c:when>
    </c:choose>
    function submitForm() {
        ...
        $("#ff").form('submit', {
            ...
            onSubmit: function(param){
                ...
                //做下处理数据
                var value = '<%=basePath%>org_news/newsListDetail?newsid='+$("#newid").combobox("getValue");
                $("#target").val(value);
