    ...
    function deleteMes(){
        $.messager.confirm('确认','确定要删除这些数据，删除数据不可恢复(慎重!)',function(r){
            if (r){
                ...
                $.ajax({
                    url:'<%=basePath%>org_index_ol/delete?ids='+ids,
...
<div class="myDiv">
    ...
    <div id="tb" style="padding:5px;height:auto">
        <div style="margin-bottom:5px">
            <a href="javascript:void(0)" onclick="addMes('<%=basePath%>org_index_ol/add','新增轮播信息')" class="easyui-linkbutton" iconCls="icon-add" plain="true">新增轮播信息</a>
            <a href="javascript:void(0)" onclick="editMes('<%=basePath%>org_index_ol/edit','编辑轮播信息')" class="easyui-linkbutton" iconCls="icon-edit" plain="true">编辑轮播信息</a>
...
<script>
    $(function () {
        $('#dg').datagrid({
            method: "POST",
            url:"<%=basePath%>org_index_ol/adminGetList",
            pageSize: 10,//初始化分页大小
            ...
            columns:[[
                ...
                {field:'descrption',title:'轮播描述',width:322,sortable:true},
                {field:'photoPath',title:'轮播图片',width:141,formatter:toWatchButton},
                {field:'url',title:'轮播跳转地址',width:200,sortable:true},
            ]],
            toolbar: '#tb',
