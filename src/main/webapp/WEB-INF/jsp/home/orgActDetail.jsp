...
<div class="myTop">
    ...
    <div class="myContent">
        <div class="one_content">
            <h1 style="margin-top: 25px;">${activity.actTheme}</h1>
            <small><fmt:formatDate value="${activity.issueDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></small>
        </div>
        <div class="two_content">${activity.actDetail}</div>
        <div class="myBanQuan">
            地址：广东省珠海市*****路***号<br/>
            版权所有：个人创作.<br/>
