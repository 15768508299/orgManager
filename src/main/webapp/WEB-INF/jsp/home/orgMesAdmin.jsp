    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-left">
                <li class="active"><a href="javascript:void(0);">网站首页</a></li>
                <li><a href="javascript:void(0);">社团信息</a></li>
                <li><a href="javascript:void(0);">社团新闻</a></li>
                <li><a href="javascript:void(0);">社团活动</a></li>
                <li><a href="javascript:void(0);">管理网站</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <shiro:guest>
                    <meta http-equiv=refresh content="1;url=<%=basePath%>org_index_ol/login">
                </shiro:guest>
                <shiro:authenticated>
                    <li><a href="javascript:void(0);"><span class="glyphicon glyphicon-user"></span>欢迎你：<shiro:principal property="userTrueName"/></a></li>
