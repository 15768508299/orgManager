...
<head>
	...
	<link rel="stylesheet" href="<%=basePath%>css/my/home/orgActivity.css">
</head>
	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-left">
				...
				<li class="active"><a href="/orgManager/org_activity/homeList">社团活动</a></li>
...
<div style="margin: 0 90px;height: auto;width: auto;">
	<div class="myContent">
		<div class="myContent_ol">
			<div class="myContent_ol_one">
				<div id="myCarousel" style="height: 100%;" class="carousel slide">
					...
					<ol class="carousel-indicators">
						<c:forEach items="${actOLs1}" var="one" varStatus="status">
			...
			<c:forEach items="${actOLs2}" var="one" varStatus="status">
		...
		<div class="myContent_list">
			<div id="blog" class="row" style="width: 100%;">
				<c:forEach items="${actList}" var="myAct">
					<div class="col-md-10 blogShort" style="width: 100%;">
						<h3>${myAct.actTheme}</h3>
						<em><fmt:formatDate value="${myAct.issueDate}" pattern="yyyy-MM-dd"></fmt:formatDate></em>
						<article><p>
								${myAct.actIntroduction}
						</p></article>
						<a class="btn btn-blog pull-right marginBottom10" href="<%=basePath%>org_activity/homeList_detail?actid=${myAct.id}">查看详情</a>
					</div>
				</c:forEach>
			</div>
		</div>
	...
	<div class="myContent_pagination">
		...
		<c:if test="${actList_nowPage!=1}">
			<li ><a href="<%=basePath%>org_activity/homeList?page=${actList_nowPage-1}">&laquo;</a></li>
		</c:if>
		<c:forEach var="i" begin="1" end = "${actList_AllPage}" step="1">
			...
			<c:if test="${i!=actList_nowPage}">
				<li name="page"><a href="<%=basePath%>org_activity/homeList?page=${i}">${i}</a></li>
			</c:if>
		</c:forEach>
		...
		<c:if test="${actList_nowPage!=actList_AllPage}">
			<li ><a href="<%=basePath%>org_activity/homeList?page=${actList_nowPage+1}">&raquo;</a></li>
		</c:if>
		</ul>
	</div>
	<div class="myBanQuan">
